...
public partial class AnswersDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("SERVER=.;DATABASE=AnswersDB;INTEGRATED SECURITY=FALSE; TrustServerCertificate=True; Trusted_Connection=true; encrypt=false; User Id=Progra6; Password=progra6");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AskStatusId).HasName("PK__AskStatu__0329362C0DBA66AB");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__Country__10D160BF59FFE3EC");
        ...
        {
            entity.HasKey(e => e.Idconfig).HasName("PK__General__3E2AEF2A94B4B4F8");
        ...
        {
            entity.HasKey(e => e.LikeId).HasName("PK__Like__A2922CF446BCB83D");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCAC5494EC37");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A554B830C39");
        ...
        {
            entity.HasKey(e => e.UserStatusId).HasName("PK__UserStat__A33F541A97FC7A01");
